...
write.csv(fits, here("results_final", "tables", "psi_min_by_species_hybrid.csv"), row.names = FALSE)
...
ggsave(plot = figSX_evt_ests, here::here("results_final", "SI", "Fig_S05_evt_psi_min.jpg"), dpi = 600, 
       height = 6, 
       width = 6, units = "in")
```
...
write_csv(table1_df, here("results_final", "tables", "Table_01.csv"))
```
...
ggsave(plot = fig1, here::here("results_final", "main", "Fig_02_dataset_scatter.jpg"), dpi = 600, 
       height = 4, 
       width = 8, units = "in")
```
...
ggsave(
  filename = here("results_final", "main", "Fig_01_conceptual_model.png"),
  plot     = final_plot,
  width    = 8,
  height   = 4,
  dpi      = 300
...
ggsave(
  filename = here("results_final", "SI", "Fig_S04_study_RE_comparison.png"),
  plot     = p_compare,
  width    = 8,
  height   = 7,
  units    = "in",
...
write_csv(
  ...
  here("results_final", "tables", "Table_S04_species_params.csv")
)
```
...
write.csv(model_results, 
          file = here("results_final", "tables", "Table_S05_gymno_angio.csv"), 
          row.names = FALSE)
...
write.csv(fixed_effects_wide, 
          file = here("results_final", "tables", "Table_S05_gymno_angio_wide.csv"), 
          row.names = FALSE)
...
ggsave(plot = figSX, here::here("results_final", "main", "Fig_03a_select_species.jpg"), dpi = 600, height = 3.5, width = 8, units = "in")
```
#----------
...
# ggsave(plot = fig3, here::here("results_final", "main", "Fig_03_model_fits.jpg"), dpi = 600, height = 4, width = 6, units = "in")
```
...
ggsave(plot = fig3.1, here::here("results_final", "SI", "Fig_S02_species_site_regression.jpg"), dpi = 600, height = 4, width = 6, units = "in")
```
...
ggsave(
  plot = figSX,
  filename = here::here("results_final", "SI", "Fig_S03_by_functional_type.jpg"),
...
ggsave(plot =figSX_studydiffs, 
        filename = here::here("results_final", "main", "Fig_05_study_differences.jpg"), 
