...
color_species =    scale_color_manual(values = c("#17154f","#17181f", "#2f357c", "#6c5d9e", "#9d9cd5", "#b0799a", "#f6b3b0", "#e48171", "#bf3729", "#e69b00", "#f5bb50", "#ada43b", "#355828",
...
color_species <- scale_color_manual(values = c(
  ...
  "SALMEL" = "#ab84a5", "UMBCAL" = "#59385c", "ABICON" = "darkblue", "PINJEF" = "gold", 
  "CALDEC" = "purple"
))
...
color_species <- scale_color_manual(values = c(
  ...
  "#df8d71", "#af4f2f", "#d48f90", "#732f30", "#ab84a5", "#59385c", "#d8b847", "#b38711", "pink"
))
...
color_species <- scale_color_manual(values = c(
  "#17154f", "#2f357c", "#6c5d9e", "#9d9cd5", "#b0799a", "#f6b3b0", "#e48171", "#bf3729",
  "#e69b00", "#f5bb50", "#ada43b", "#355828", "#5b859e", "#1e395f", "#75884b", "#1e5a46",
  "#df8d71", "#af4f2f", "#d48f90", "#732f30", "#ab84a5", "#59385c", "#d8b847", "#b38711", "darkgreen"
))
...
```{r}
color_species = scale_color_manual(values = c(
  "#17154f", "#2f357c", "#6c5d9e", "#9d9cd5", "#b0799a", "#f6b3b0", "#e48171",
  "#bf3729", "#e69b00", "#f5bb50", "#ada43b", "#355828", "#5b859e", "#1e395f",
  "#75884b", "#1e5a46", "#df8d71", "#af4f2f", "#d48f90", "#732f30", "#ab84a5",
  "#59385c", "#d8b847", "#b38711", "#b38651"
))
...
fig5a <- ggplot() +
  ...
  geom_smooth(data = q3_df, aes(y = min_mwp, x = plc50_stem),
              method = "lm", se = FALSE, color = "#ab84a5") +
