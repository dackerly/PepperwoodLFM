...
traits <- c(
  "plc50_stem", "psi_tlp", "ldmc", "sla", "min_pd", "swc", "swc_g_calc", "min_pd"
)
...
ggsave(
  plot = fig_all_labeled,
  filename = here::here("figures", "fig5_ABCD_LFMint.jpg"),
  dpi = 600,
  width = 6,
  height = 8
)
...
ggsave(
  plot = fig_all_labeled,
  filename = here::here("figures", "fig8_AB.jpg"),
  dpi = 600,
  width = 6,
  height = 6
)
...
fig5a <- build_panel_xy_split(
  ...
  geom_point(
    data = salvia_df,
    aes(x = plc50_stem, y = min_wp, color = species),
    shape = 21, fill = NA,
    size = salvia_ring_size, stroke = salvia_ring_stroke,
    show.legend = FALSE
  )
...
# ----------------------------
ggsave(
  filename = here::here("figures", "Fig9_traits_params_ldmc_sla_LFMint.jpg"),
  plot = p_final,
  dpi = 600,
  width = 6,
  height = 8
...
ggsave(filename = here::here("figures", "Fig9_ftype_LFMint.jpg"), plot = p_final, dpi = 600, width = 6, height = 8)
```
...
ggsave(filename = here::here("figures", "Fig9_growthform.jpg"), plot = p_final, dpi = 600, width = 6, height = 8)
```
...
ggsave(filename = here::here("figures", "Fig9_leafhabit.jpg"), plot = p_final, dpi = 600, width = 6, height = 8)
```
...
ggsave(filename = here::here("figures", "Fig9_genus.jpg"), plot = p_final, dpi = 600, width = 6, height = 8)
```
...
# ----------------------------
ggsave(
  filename = here::here("figures", "traits_params_ldmc_sla_LFMmax.jpg"),
  plot = p_final,
  dpi = 600,
  width = 6,
  height = 8
