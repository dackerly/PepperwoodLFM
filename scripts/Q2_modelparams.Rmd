...
spres <- concept_params_df %>%
  ...
  mutate(
    ...
    SpCode6    = species,
    minWP      = minwp,
    maxLFM     = intercept_lfm     # <-- NEW: use max_lfm directly
  )
...
# ----------------------------
jpeg(
  filename = here::here("figures", "Fig2_genus_LFMint.jpg"),
  width    = 7,
  height   = 4.5,
  units    = "in",
  res      = 300
...
plot(
  ...
  type = "n",
  xlab = "Minimum Minimum Water Potential (MPa)",
  ylab = "LFMintercept (%) @ Midday Water Potential = 0",
  yaxt = "n"
)
axis(2, at = seq(0, 400, 100), labels = seq(0, 400, 100), las = 1)
...
# ----------------------------
jpeg(
  filename = here("figures", "Fig2_species_actualMax.jpg"),
  width = 7,
  height = 4.5,
  units = "in",
  res = 300
