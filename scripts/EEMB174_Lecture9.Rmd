...
```{r}
covid_county_cases <- tibble(name=c("Santa Barbara" , "Goleta", "Santa Maria", "Ojai","Santa Paula", "Fillmore"), loc=c(1,2,3,4, 5,6), county= c(1,1,1,2,2,2), pop=c(92100,31100,107000, 20379, 33751, 18731) , cases=c(14721,5079,22741, 3638, 12180, 6913))
```

```{r}
m.covid.counties <- quap(alist(
  cases ~ dbinom(pop, mu[county]),
  mu[county] ~ dunif(0,1),
  data = covid_county_cases
))

precis(m.covid.counties)
```
